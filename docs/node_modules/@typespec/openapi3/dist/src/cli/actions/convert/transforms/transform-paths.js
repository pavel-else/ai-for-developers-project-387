...
export function transformPaths(paths, context) {
    ...
    for (const route of Object.keys(paths)) {
        ...
        for (const verb of supportedHttpMethods) {
            ...
            const directives = operation.deprecated
                ? [{ name: "deprecated", message: "deprecated" }]
                : [];
            // Check if we need to split the operation due to incompatible content types
            const splitOperations = splitOperationByContentType(operationId, decorators, dedupeParameters([...routeParameters, ...parameters]), operation.description, requestBodies, operationResponses, tags, fixmes, directives, usedOperationIds);
 ...
 */
function splitOperationByContentType(operationId, decorators, parameters, doc, requestBodies, responses, tags, fixmes, directives, usedOperationIds) {
